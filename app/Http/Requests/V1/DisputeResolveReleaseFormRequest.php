...
final class DisputeResolveReleaseFormRequest extends AbstractValidatedRequest
{
    /**
     * @return array{currency: string, reason_code: string, notes: string, idempotency_key: string, resolution_notes: ?string}
     */
