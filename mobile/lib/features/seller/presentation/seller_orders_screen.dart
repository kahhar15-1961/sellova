...
class _SellerOrdersScreenState extends ConsumerState<SellerOrdersScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final filtered =
        _tab == null ? orders : orders.where((e) => e.status == _tab).toList();
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  _tabBtn('To ship', _tab == SellerOrderStatus.toShip,
                      () => setState(() => _tab = SellerOrderStatus.toShip)),
                  _tabBtn('Shipped', _tab == SellerOrderStatus.shipped,
                      () => setState(() => _tab = SellerOrderStatus.shipped)),
                  _tabBtn('Delivered', _tab == SellerOrderStatus.delivered,
                      () => setState(() => _tab = SellerOrderStatus.delivered)),
                  _tabBtn('Cancelled', _tab == SellerOrderStatus.cancelled,
                      () => setState(() => _tab = SellerOrderStatus.cancelled)),
                ],
              ),
            ),
            Expanded(
              child: busy && orders.isEmpty
                  ...
                  : filtered.isEmpty
                      ? SellerEmptyState(
                          title: 'No orders yet',
                          subtitle: 'Orders will appear here as sales come in.',
                          ctaLabel: 'Refresh',
                          onTap: () =>
                              ref.read(sellerOrdersProvider.notifier).refresh(),
                        )
                            ...
                            itemBuilder: (_, i) {
                              ...
                              return Container(
                                ...
                                child: ListTile(
                                  ...
                                  subtitle: Text(
                                      '${order.customerName} • ${sellerNiceDate(order.orderDate)}'),
                                  trailing: Column(
