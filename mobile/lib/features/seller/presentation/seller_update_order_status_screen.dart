...
class SellerUpdateOrderStatusScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SellerUpdateOrderStatusScreen> createState() =>
      _SellerUpdateOrderStatusScreenState();
}

class _SellerUpdateOrderStatusScreenState
    extends ConsumerState<SellerUpdateOrderStatusScreen> {
  SellerOrderStatus _selected = SellerOrderStatus.processing;
          ...
          ...<SellerOrderStatus>[
            ...
            (s) => _StatusTile(
              ...
              subtitle: switch (s) {
                ...
                SellerOrderStatus.buyerReview => 'Waiting for buyer review',
                ...
                : () async {
                    ...
                    try {
                      await ref
                          ...
                          .updateStatus(widget.orderId, _selected);
                      if (context.mounted) {
