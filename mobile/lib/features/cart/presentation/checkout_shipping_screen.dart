                  ...
                  children: <Widget>[
                    ...
                    if (!draft.needsShipping)
                      ...
                      _ShippingOptionTile(
                        ...
                        feeLabel: '\$20.00',
                        selected: draft.shippingMethod ==
                            CheckoutShippingMethod.standard,
                        onTap: () => ref
                            .read(checkoutDraftProvider.notifier)
                            .updateShipping(CheckoutShippingMethod.standard),
                      ),
                      const SizedBox(height: 10),
                      _ShippingOptionTile(
                        ...
                        onTap: () => ref
                            .read(checkoutDraftProvider.notifier)
                            .updateShipping(CheckoutShippingMethod.express),
                      ),
                    ],
                  ],
                ),
        ...
        child: Ink(
          ...
          decoration: selected
              ? cartCardDecoration(cs).copyWith(
                  ...
                  border: Border.all(
                      color: cs.primary.withValues(alpha: 0.52), width: 1.5),
                )
              : cartCardDecoration(cs),
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
              ...
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(address.detailsAddress,
                        style: Theme.of(context)
                            .textTheme
                            .bodyMedium
                            ?.copyWith(color: kCartMuted, height: 1.35)),
                    const SizedBox(height: 4),
                    Text(address.phone,
                        style: Theme.of(context)
                            .textTheme
