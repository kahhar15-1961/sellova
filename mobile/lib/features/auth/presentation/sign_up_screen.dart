...
class _SignUpScreenState extends ConsumerState<SignUpScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final message = switch (error) {
        ApiException() => error.message.isNotEmpty
            ? error.message
  ...
  Future<void> _google() async {
    ...
    try {
      ...
      final message = switch (error) {
        ApiException() =>
          error.message.isNotEmpty ? error.message : 'Google sign-up failed.',
  ...
  Future<void> _apple() async {
    ...
    try {
      ...
      final message = switch (error) {
        ApiException() =>
          error.message.isNotEmpty ? error.message : 'Apple sign-up failed.',
  ...
  Widget build(BuildContext context) {
    ...
    return AuthLandingShell(
      ...
      subtitle:
          'Set up a buyer profile and get access to orders, messages, and protected payments.',
